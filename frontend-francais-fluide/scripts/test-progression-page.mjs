...
async function testProgressionPage() {
  ...
  try {
    ...
    if (progressData.success && progressData.data) {
      ...
      const requiredFields = ['wordsWritten', 'accuracy', 'timeSpent', 'exercisesCompleted', 'currentStreak', 'level', 'xp'];
      ...
      console.log('📊 Objectifs hebdomadaires générés:', weeklyGoals.map(goal => ({
        title: goal.title,
      ...
      console.log('📊 Succès générés:', achievements.map(achievement => ({
