      ...
      questions: [
        {
          ...
          answer:
            "FrançaisFluide est une plateforme d'apprentissage du français qui utilise l'intelligence artificielle pour vous aider à améliorer votre écriture, grammaire et vocabulaire. Vous pouvez pratiquer avec des exercices adaptatifs, des dictées audio et recevoir des corrections personnalisées.",
        },
        {
          question: "Quels sont les différents plans d'abonnement ?",
          answer:
            'Nous proposons 4 plans : Démo Gratuite (limité), Étudiant (14.99$/mois), Premium (29.99$/mois) et Établissement (149.99$/mois). Chaque plan offre des fonctionnalités différentes selon vos besoins.',
        },
        {
          question: 'Puis-je annuler mon abonnement à tout moment ?',
          answer:
            "Oui, vous pouvez annuler votre abonnement à tout moment depuis votre tableau de bord. L'annulation prend effet à la fin de votre période de facturation en cours.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            'Certaines fonctionnalités sont disponibles hors ligne avec le plan Premium et Établissement. Les corrections IA et les exercices avancés nécessitent une connexion internet.',
        },
        {
          question: 'Mes données sont-elles sécurisées ?',
          answer:
            'Oui, nous utilisons un chiffrement de bout en bout et respectons le RGPD. Vos données personnelles sont protégées et ne sont jamais partagées avec des tiers.',
        },
        {
          question: 'Comment puis-je exporter mes données ?',
          answer:
            'Vous pouvez exporter toutes vos données depuis la page Paramètres > Confidentialité. Un fichier ZIP contenant vos textes, exercices et statistiques vous sera envoyé par email.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "Notre IA analyse vos erreurs récurrentes et votre niveau de progression pour proposer des exercices personnalisés. Plus vous pratiquez, plus les exercices s'adaptent à vos besoins spécifiques.",
        },
        {
          question: 'Puis-je suivre mes progrès ?',
          answer:
            'Oui, vous avez accès à un tableau de bord détaillé avec vos statistiques, graphiques de progression, succès débloqués et objectifs personnalisés.',
        },
        {
          question: 'Y a-t-il des exercices pour tous les niveaux ?',
          answer:
            "Absolument ! Nous proposons des exercices pour débutants, intermédiaires et avancés. L'IA ajuste automatiquement la difficulté selon votre niveau.",
        },
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <div key={categoryIndex}>
                    ...
                    <div className="space-y-4">
                      {category.questions.map((item, itemIndex) => (
                        <div key={itemIndex} className="rounded-lg border border-gray-200 p-4">
          ...
          {activeTab === 'contact' && (
            <div>
              <h2 className="mb-6 text-2xl font-bold text-gray-900">Contactez-nous</h2>
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={e =>
                            setContactForm(prev => ({ ...prev, priority: e.target.value }))
                          }
                          className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                        >
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="mb-4 text-lg font-semibold text-gray-900">Ressources utiles</h3>
          ...
          {activeTab === 'tickets' && (
            <div>
              <h2 className="mb-6 text-2xl font-bold text-gray-900">Mes demandes de support</h2>
              ...
              {tickets.length > 0 ? (
                ...
                <div className="py-12 text-center">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Aucune demande</h3>
