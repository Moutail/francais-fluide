  ...
  return (
    <Card className={`p-6 ${className}`}>
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 bg-green-500 rounded-full border border-green-500" style={{ background: 'transparent' }}></div>
          <span className="text-gray-600">Moyenne</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 bg-yellow-500 rounded-full border border-yellow-500" style={{ background: 'transparent' }}></div>
