...
export default function CreateUserForm({ onBack, onSuccess }: CreateUserFormProps) {
  ...
  const roles = [
    { value: 'user', label: 'Utilisateur', description: 'Accès standard à la plateforme' },
    {
      value: 'tester',
      label: 'Testeur',
      description: 'Accès pour tester les nouvelles fonctionnalités',
    },
  ...
  const subscriptionPlans = [
    ...
    {
      value: 'etudiant',
      label: 'Étudiant (12 mois)',
      description: 'Accès complet pour les étudiants',
    },
    {
      value: 'premium',
    ...
    {
      value: 'etablissement',
      label: 'Établissement (12 mois)',
      description: 'Accès pour les institutions',
    },
  ];
  ...
  if (success) {
    return (
      <Card className="mx-auto max-w-md p-8 text-center">
        ...
        <h2 className="mb-2 text-2xl font-bold text-gray-900">Utilisateur créé avec succès !</h2>
        <p className="mb-6 text-gray-600">
          L'utilisateur <strong>{formData.name}</strong> a été créé et peut maintenant se connecter.
        </p>
        <Button onClick={onSuccess}>Retour à la liste</Button>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600">Ajouter un nouvel utilisateur à la plateforme</p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full rounded-lg border px-4 py-2 pr-10 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 ${
