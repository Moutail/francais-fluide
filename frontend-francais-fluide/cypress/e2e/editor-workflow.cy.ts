...
describe("Workflow de l'éditeur", () => {
  ...
  describe("Interface de l'éditeur", () => {
    ...
    it('permet de saisir du texte', () => {
      ...
      cy.get('[data-testid="smart-editor"] textarea').type(testText).should('have.value', testText);
    });
  ...
  describe('Collaboration en temps réel', () => {
    ...
    it('synchronise les changements en temps réel', () => {
      ...
      cy.get('[data-testid="smart-editor"] textarea').should(
        'have.value',
        'Contenu modifié par un autre utilisateur'
      );
    });
  });
  ...
  describe('Outils et fonctionnalités avancées', () => {
    ...
    it("permet d'utiliser les raccourcis clavier", () => {
      ...
      cy.get('[data-testid="smart-editor"] textarea').should('have.value', '**Texte sélectionné**');
    });
  ...
  describe('Accessibilité et UX', () => {
    ...
    it("affiche des messages d'erreur accessibles", () => {
      ...
      cy.get('[data-testid="suggestions-panel"]').should('have.attr', 'aria-live', 'polite');
    });
  ...
  describe('Gestion des erreurs', () => {
    ...
    it('récupère après une erreur', () => {
      ...
      cy.intercept('POST', '/api/grammar', { fixture: 'grammar-response.json' }).as(
        'grammarSuccess'
      );
